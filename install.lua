-- Reactor Full automation program
--
--
 
local libURL = "https://raw.githubusercontent.com/Erani0/Draconic-Reactor-Controll/main/lib/f.lua"
local reactorURL = "https://raw.githubusercontent.com/Erani0/Draconic-Reactor-Controll/main/drmon.lua"
local batURL = "https://raw.githubusercontent.com/Erani0/Draconic-Reactor-Controll/main/bat.lua"
...
function detect()
  ...
  for i = 1, #p do
    ...
    if string.find(p[i],"flux_gate") then
      if string.find(first,"flux_gate") then
    second=p[i]
      else
    first=p[i]
      end
